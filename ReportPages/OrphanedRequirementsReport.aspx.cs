...
public partial class RVDReport : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (pnlReportViewer.Visible == true && Session["svReportORR"] != null)
        {
            ReportDocument reportDocument = (ReportDocument)Session["svReportORR"];
    ...
    protected void btnRunReport_Click(object sender, EventArgs e)
    {
        ...
        CrystalReportViewer1.ReportSource = crHelper.PrepareReportSource("~/Reports/OrphanedRequirements_Report.rpt");
        ...
        Session["svReportORR"] = crHelper.GetReportDocument();
