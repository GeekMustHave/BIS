...
public partial class UCDReport : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (pnlReportViewer.Visible == true && Session["svReportUCD"] != null)
        {
            ReportDocument reportDocument = (ReportDocument)Session["svReportUCD"];
    ...
    protected void btnRunReport_Click(object sender, EventArgs e)
    {
        ...
        CrystalReportViewer1.ReportSource = crHelper.PrepareReportSource("~/Reports/UseCaseDetailReportV1.rpt");
        ...
        Session["svReportUCD"] = crHelper.GetReportDocument();
