...
public partial class UCDocumentReport : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (pnlReportViewer.Visible == true && Session["svReportUCDocument"] != null)
        {
            ReportDocument reportDocument = (ReportDocument)Session["svReportUCDocument"];
    ...
    protected void btnRunReport_Click(object sender, EventArgs e)
    {
        ...
        Session["svReportUCDocument"] = crHelper.GetReportDocument();
