...
public partial class RVDReport : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (pnlReportViewer.Visible == true && Session["svReportRVD"] != null)
        {
            ReportDocument reportDocument = (ReportDocument)Session["svReportRVD"];
    ...
    protected void btnRunReport_Click(object sender, EventArgs e)
    {
        ...
        CrystalReportViewer1.ReportSource = crHelper.PrepareReportSource("~/Reports/RequirementValidationDocument_V11.rpt");
        ...
        Session["svReportRVD"] = crHelper.GetReportDocument();
